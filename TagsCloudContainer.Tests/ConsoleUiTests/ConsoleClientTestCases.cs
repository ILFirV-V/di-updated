...
public partial class ConsoleClientTests
{
    private static IEnumerable<TestCaseData> ContainsTestCases()
    {
        ...
        var imageFileName = "testResultImage";
        yield return new TestCaseData($"-i {filePath} -o {testDirectory} -n {imageFileName}",
                GetImagePath(testDirectory, imageFileName, "png"))
            .SetName("BaseCommands");
        yield return new TestCaseData($"-i {filePath} -o {testDirectory} -n {imageFileName} -e jpg",
                GetImagePath(testDirectory, imageFileName, "jpeg"))
            .SetName("JpgCommands");
        yield return new TestCaseData($"-i {filePath} -o {testDirectory} -n {imageFileName} -e png -p S V A",
                GetImagePath(testDirectory, imageFileName, "png"))
            .SetName("PngCommandsWithWordSettings");
        yield return new TestCaseData(
                $"-i {filePath} -o {testDirectory} -n {imageFileName} -p S V A ADV NUM -w 800 -h 600 -b White -c Black -f Arial",
                GetImagePath(testDirectory, imageFileName, "png"))
            .SetName("BaseCommandsWithImageSettings");
        yield return new TestCaseData($"-i {filePath} -o {testDirectory} -n {imageFileName} -e jpeg -b Red -c Blue",
                GetImagePath(testDirectory, imageFileName, "jpeg"))
    ...
    private static IEnumerable<TestCaseData> EqualsTestCases()
    {
        ...
        var filePath = GetTestFilePath();
        var imageFileName = "testEqualsResultImage";
        yield return new TestCaseData($"-i {filePath} -o {testDirectory} -n {imageFileName}JpgCommands -e jpg",
                GetImagePath(testDirectory, $"{imageFileName}JpgCommands", "jpeg"),
                GetImagePath(sourceDirectory, "result", "jpeg"))
            .SetName("JpgCommands");
        yield return new TestCaseData(
                $"-i {filePath} -o {testDirectory} -n {imageFileName}PngCommandsWithWordSettings -p S V A",
                GetImagePath(testDirectory, $"{imageFileName}PngCommandsWithWordSettings", "png"),
                GetImagePath(sourceDirectory, "resultVSA", "png"))
            .SetName("PngCommandsWithWordSettings");
        yield return new TestCaseData(
                $"-i {filePath} -o {testDirectory} -n {imageFileName}PngCommandsOnlyNouns -e png -p S",
        ...
        yield return new TestCaseData(
                $"-i {filePath} -o {testDirectory} -n {imageFileName}BaseCommandsWithImageSettings -e png -p S V A ADV NUM -w 800 -h 600 -b White -c Black -f Arial",
            ...
            .SetName("BaseCommandsWithImageSettings");
        yield return new TestCaseData(
                $"-i {filePath} -o {testDirectory} -n {imageFileName}PngCommandsWithRedBackAndBlueWords -e png -w 800 -h 600 -b Red -c Blue -f Arial",
        ...
        yield return new TestCaseData($"-i {filePath} -o {testDirectory} -n {imageFileName}BaseCommands",
